  ...
  return (
    <div className="relative mt-11 flex w-full justify-between gap-5 max-sm:flex-col sm:items-center">
      ...
      <Select onValueChange={(value) => handleUpdateParams(value)}>
        <SelectTrigger className="line-clamp-1 flex min-h-[56px] items-center gap-3 border light-border background-light800_dark300 p-4 body-regular text-dark500_light700 sm:max-w-[210px]">
